...
//        digitalWrite(red_led, ledState1);
//        digitalWrite(green_led, LOW);
//        digitalWrite(blue_led, LOW);
//    }
//  }
...
//        digitalWrite(green_led, ledState2);
//        digitalWrite(red_led, LOW);
//        digitalWrite(blue_led, LOW);
//    }
//  }
//
//  if (state3 != lastButton3State) {
//    lastButton3State = state3;
//      if (state3 == LOW) {
//        ledState3 = (ledState3 == HIGH) ? LOW: HIGH;
//        digitalWrite(blue_led, ledState3);
//        digitalWrite(green_led, LOW);
//        digitalWrite(red_led, LOW);
//    }
//  }
//
//  if (state4 != lastButton4State) {
//    lastButton4State = state4;
//      if (state4 == LOW) {
